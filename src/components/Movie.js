export const DefautlMovies = [
    {
        title: "Chernobyl",
        description: "Chernobyl décrit la catastrophe nucléaire de Tchernobyl survenue en avril 1986 dans le territoire de la République socialiste soviétique d'Ukraine (URSS) et les efforts de nettoyage menés par les autorités soviétiques, sans précédent, qui ont suivi l'explosion du réacteur nucléaire.",
        posterURL: "https://m.media-amazon.com/images/M/MV5BMmI2OTMxZTUtMTM5OS00MGNiLWFhNGMtYzJiODUwYjRmODA5XkEyXkFqcGdeQXVyMTM0NTc2NDgw._V1_.jpgimdb.com/title/tt7366338/",
        rating: "9.5"
    },
    {
        title: "Lost",
        description: "La série contient des éléments surnaturels et de science-fiction, et suit les survivants de l'accident aérien du vol 815 de la compagnie aérienne Oceanic Airlines, entre Sydney (Australie) et Los Angeles (États-Unis), après que l'avion s'est écrasé sur une île mystérieuse quelque part dans l'océan Pacifique Sud.",
        posterURL: "https://m.media-amazon.com/images/M/MV5BNzhlY2E5NDUtYjJjYy00ODg3LWFkZWQtYTVmMzU4ZWZmOWJkXkEyXkFqcGdeQXVyNTA4NzY1MzY@._V1_FMjpg_UX1000_.jpg",
        rating: "9"
    },
    {
        title: "Elite",
